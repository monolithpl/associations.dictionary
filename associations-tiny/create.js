...
readEachLine('../sourcedata/eat-stimulus-response.xml', function(line) {
...
readEachLine('../sourcedata/eat-response-stimulus.xml', function(line) {
	if (line.indexOf('<response word=') > -1) {
		limitCounter = 0
...
readEachLine('../sourcedata/florida-cue-target.xml', function(line) {
...
readEachLine('../sourcedata/florida-target-cue.xml', function(line) {
	if (line.indexOf('<target word=') > -1) {
		limitCounter = 0
...
readEachLine('../sourcedata/wordassociation.org.xml', function(line) {
	if (line.indexOf('\t') == -1) {
		headWord = line
		if (headWord == 'length') headWord = 'length_'
		if (headWord == 'shift') headWord = 'shift_'
...
readEachLine('../sourcedata/taboo.net.xml', function(line) {
	if (line.indexOf('\t') == -1) {
		headWord = line
		if (headWord == 'length') headWord = 'length_'
		if (headWord == 'shift') headWord = 'shift_'
